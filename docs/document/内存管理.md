...
<div align="center">
  <table style="border-collapse:collapse; border:none;">
    <tr>
      <td style="padding:0 12px 0 0; border:none; vertical-align:top;">
        <img src="../img/swaptest.png" alt="swaptest 结果" style="width:300px; height:180px; object-fit:contain; display:block;" />
        <div style="height:8px;"></div>
        <img src="../img/mmapswaptest.png" alt="mmapswaptest 结果" style="width:300px; height:180px; object-fit:contain; display:block;" />
      </td>
      <td style="padding:0; border:none; vertical-align:top;">
        <img src="../img/swapconctest多打印版本（多进程）.png" alt="swapconctest 结果" style="width:320px; height:368px; object-fit:contain; display:block;" />
      </td>
    </tr>
  </table>
</div>
