...
图 0-1 展示了 OopsOS 内存管理的核心路径：进程地址空间、VMA、页表与缺页处理之间的关系。

<img src="../img/mm_overview.png" alt="图 0-1 内存管理总览" width="680" />

### 0.2 关键流程图

图 0-2 给出了缺页处理的高层流程，覆盖懒分配、swap 换入与 mmap 缺页路径。

<img src="../img/page_fault_flow.png" alt="图 0-2 缺页处理流程" width="400" />

图 0-3 展示 swap 置换与换入流程的主干路径。

<img src="../img/swap_flow.png" alt="图 0-3 Swap 置换/换入流程" width="400" />

图 0-4 展示 COW 写时复制的触发与复制流程。

<img src="../img/cow_flow.png" alt="图 0-4 COW 写时复制流程" width="230" />

图 0-5 展示文件映射页在缺页与淘汰时的处理路径（MAP_SHARED 写回）。

<img src="../img/mmap_flow.png" alt="图 0-5 mmap 缺页与写回流程" width="350" />

图 0-6 展示标准 Clock（二次机会）算法的扫描与指针位置示意。

<img src="../img/mm_clock_state.png" alt="图 0-6 Clock（二次机会）状态示意" width="400" />
...
<img src="../img/lazy_alloc_principle.png" alt="图 2-2 懒分配原理示意" width="200" />
...
<img src="../img/swap_principle.png" alt="图 2-5 Swap 原理示意" width="140" />
...
<img src="../img/demand_load_principle.png" alt="图 2-6 按需装入原理示意" width="120" />
